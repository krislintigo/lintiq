export interface LintiqErrorJSON {
  name: string
  message: string
  code: number
  className: string
...
interface ErrorProperties extends Omit<LintiqErrorJSON, 'message'> {
  type: string
}

export class LintiqError extends Error {
...
export class BadRequest extends LintiqError {
...
export class NotAuthenticated extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 402 - Payment Error
export class PaymentError extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 403 - Forbidden
export class Forbidden extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 404 - Not Found
export class NotFound extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
export class MethodNotAllowed extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 406 - Not Acceptable
export class NotAcceptable extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 408 - Timeout
export class Timeout extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 409 - Conflict
export class Conflict extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 410 - Gone
export class Gone extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 411 - Length Required
export class LengthRequired extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 422 Unprocessable
export class Unprocessable extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
export class TooManyRequests extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 500 - General Error
export class GeneralError extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 501 - Not Implemented
export class NotImplemented extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 502 - Bad Gateway
export class BadGateway extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
// 503 - Unavailable
export class Unavailable extends LintiqError {
  constructor(message?: ErrorMessage, data?: any) {
...
export const convert = (error: any) => {
  if (!error) {
    return error
  }

  const LintiqError = (errors as any)[error.name]
  const result = LintiqError
    ? new LintiqError(error.message, error.data)
